...
public class WrapperQueue {
    ...
    public WrapperQueue(int capacity) {
        ...
        //Create some Extra Space for consumer to consume values  from queue after reading occurs from file
    ...
    //4.Consumer consumes it from Consumer queue if any else consumes from producer queue
